        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LearnerPhoto = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModuleImage1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModuleImage2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModulePDF1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModulePDF2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModuleVideo1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModuleVideo2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
